	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input name="pcontact" type="text" class="form-control" id="pcontact" pattern="01[5|6|7|8|9][0-9]{8}" value="<?= isset($pcontact)? $pcontact: '' ; ?>" placeholder="" required="">
	  	</div>
	  	<div class="form-group">
		    <label for="class">Student year</label>
	  	...
	  	<div class="form-group">
		  <div class="form-group">
		    <label for="class">Student course</label>
		    <select name="class" class="form-control" id="class" required="">
		    	<option>Select</option>
		    	<option value="1st">Civil Engineering</option>
		    	<option value="2nd">Electrical Engineering</option>
		    	<option value="3rd">Computer Engineering</option>
		    </select>
	  	</div>
	  	<div class="form-group">
