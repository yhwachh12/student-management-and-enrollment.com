...
<div class="col-sm-6">
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label for="class">Student curse</label>
		    <select name="class" class="form-control" id="class" required="" value="">
		    	<option>Select</option>
		    	<option value="1st" <?= $row['class']=='1st'? 'selected':'' ?>>Civil Engineering</option>
		    	<option value="2nd" <?= $row['class']=='2nd'? 'selected':'' ?>>Electrical Engineering</option>
		    	<option value="3rd" <?= $row['class']=='3rd'? 'selected':'' ?>>Computer Engineering</option>
		    	<
		    </select>
	  	</div>
	  	<div class="form-group">
